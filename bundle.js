...
//reject
var promise2 = Promise.reject(42);
...
var p2 = Promise.reject(thenable1);
...
var p15 = Promise.all([p12, p13, p14]);
...
var p19 = Promise.race([p16, p17, p18]);
...
var p21 = Promise.reject(61);

var p22 = new Promise(function (resolve, reject) {
	resolve(62);
});

var p23 = Promise.race([p20, p21, p22]);
...
function run(taskDef) {
	...
	(function step() {
		...
		if (!result.done) {
			...
			var _promise = Promise.resolve(result.value);
...
var MyPromise = function (_Promise) {
	_inherits(MyPromise, _Promise);

	function MyPromise() {
		_classCallCheck(this, MyPromise);

		return _possibleConstructorReturn(this, Object.getPrototypeOf(MyPromise).apply(this, arguments));
	}

	_createClass(MyPromise, [{
		key: 'success',
		value: function success(resolve, reject) {
			return this.then(resolve, reject);
		}
	}, {
		key: 'failure',
		value: function failure(reject) {
...
var promise6 = new MyPromise(function (resolve, reject) {
	resolve(70);
});
...
},{"babel-polyfill":2,"fs":291}],2:[function(require,module,exports){
(function (global){
/* eslint max-len: 0 */
...
},{"_process":292}],291:[function(require,module,exports){
